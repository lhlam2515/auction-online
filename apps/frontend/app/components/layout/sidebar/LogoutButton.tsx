    ...
    <Tooltip delayDuration={0}>
      <TooltipTrigger asChild>
        <Button
          ...
          onClick={onLogout}
          className={cn(
            "hover:bg-destructive/10 hover:text-destructive text-destructive group mt-auto w-full transition-all duration-300",
            isCollapsed ? "justify-center px-2" : "justify-start gap-3 px-3"
          )}
        >
          <LogOut className="mr-1 h-4 w-4 shrink-0 transition-colors" />
          <span
            className={cn(

import type { RevenueAnalytics, SpendingAnalytics } from "@repo/shared-types";
...
class AnalyticsService {
  ...
  /**
   * Get seller revenue analytics over a time period
   * @param sellerId - The seller's user ID (UUID)
   * @param period - Time period: 7d, 30d, or 12m
   */
